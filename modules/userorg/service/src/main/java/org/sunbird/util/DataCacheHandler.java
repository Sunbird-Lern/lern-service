...
public class DataCacheHandler implements Runnable {
  ...
  private void initOrgTypeMap() {
    ...
    try {
      orgTypeConfigMap = (JsonUtil.MAPPER).readValue(orgTypeConfig,
              new TypeReference<HashMap<String, Object>>() {
              });
      if (orgTypeConfigMap.containsKey(JsonKey.FIELDS)) {
        List<OrganisationType> orgTypeList = (JsonUtil.MAPPER).convertValue(orgTypeConfigMap.get(JsonKey.FIELDS),
