...
public class ApplicationStart {
  ...
  private static final Logger slf4jLogger = LoggerFactory.getLogger(ApplicationStart.class);
  ...
  public ApplicationStart(ApplicationLifecycle lifecycle, Environment environment) {
    slf4jLogger.info("ApplicationStart:ApplicationStart: Start");
    ...
    slf4jLogger.info("keymanger.init():starts");
    KeyManager.init();
    slf4jLogger.info("ApplicationStart:ApplicationStart: End");
  }
