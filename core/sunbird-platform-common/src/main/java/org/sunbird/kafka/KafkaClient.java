...
public class KafkaClient {
  ...
  public static void init() {
    ...
    loadTopics();
    logger.info("KafkaClient:init: Kafka client initialized eagerly.");
  }
