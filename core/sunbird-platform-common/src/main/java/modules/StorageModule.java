...
import org.sunbird.utils.CloudStorageConfigUtil;
 ...
 * sunbird_account_endpoint          — optional endpoint override (e.g. Ceph S3)
 * </pre>
 *
...
public class StorageModule extends AbstractModule {
    ...
    public IStorageService provideStorageService() {
        ...
        String endpoint       = ProjectUtil.getConfigValue(JsonKey.ACCOUNT_ENDPOINT);

        StorageConfig.StorageType storageType = CloudStorageConfigUtil.resolveStorageType(storageTypeStr);
        ...
        // For ACCESS_KEY, provide the account secret.
        // For OIDC / IAM / IAM_ROLE / INSTANCE_PROFILE, the cloud SDK resolves
        // credentials automatically (Workload Identity env vars, instance metadata,
        // etc.). Passing an empty secret would cause auth failures with some SDKs.
